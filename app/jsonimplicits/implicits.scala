...
object RequestWrites {
  def fromWrites[T](implicit delegate: Writes[T]): RequestWrites[T] =
    (_: RequestHeader) => delegate
}
...
object model {
  ...
  implicit def instanceRequestWriter(implicit
    ...
    implicit val instanceSpecificationWriter: Writes[InstanceSpecification] =
      Json.writes[InstanceSpecification]
    implicit val managementEndpointWriter: Writes[ManagementEndpoint] =
      Json.writes[ManagementEndpoint]
  ...
  implicit val launchTemplateVersionWriter: Writes[LaunchTemplateVersion] =
    Json.writes[LaunchTemplateVersion]
  implicit val launchTemplateWriter: Writes[LaunchTemplate] =
    Json.writes[LaunchTemplate]
  ...
  implicit val reservationWriter: Writes[Reservation] = {
    implicit val recurringCharge: Writes[RecurringCharge] =
  ...
  implicit val sourceStatusWriter: Writes[SourceStatus] =
    new Writes[SourceStatus] {
